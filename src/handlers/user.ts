...
import { hashPassword, compareHash } from "../auth/becrypt";
import { JwtAuthRequest, newJwt } from "../auth/jwt";
...
export interface IHandlerUser {
  ...
  getUserByPayloadId(req: JwtAuthRequest, res: Response): Promise<Response>;
  getUserByUsername(req: JwtAuthRequest, res: Response): Promise<Response>;
}
  ...
  async login(req: Request, res: Response): Promise<Response> {
    ...
    return this.repo
      ...
      .then((user) => {
        ...
        const accessToken = newJwt({ username, id: user.id });
